...
GO
SELECT COUNT(DISTINCT(RecordedWhen )) FROM Warehouse.ColdRoomTemperatures_Archive;
GO
SELECT APPROX_COUNT_DISTINCT(RecordedWhen) FROM Warehouse.ColdRoomTemperatures_Archive;
GO
...
SELECT COUNT(DISTINCT(id)) FROM dbo.A;
SELECT APPROX_COUNT_DISTINCT(id) FROM dbo.A;

SELECT COUNT(DISTINCT(c1)) FROM dbo.A;
SELECT APPROX_COUNT_DISTINCT(c1) FROM dbo.A;